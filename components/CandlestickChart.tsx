...
const CandlestickChart = ({
  ...
  const fetchOHLCData = async (selectedPeriod: Period) => {
    try {
      ...
      // CRITICAL FIX: Remove interval parameter - OHLC endpoint doesn't support it
      const newData = await fetcher<OHLCData[]>(`coins/${coinId}/ohlc`, {
        vs_currency: 'usd',
        days: days.toString(), // Ensure it's a string
        // Removed: interval, precision (not supported on free API)
      });
